...
function Update({ infoUpdate,setView,getAll }) {
  ...
  useEffect(() => {
    ...
    setOpcionEngineOilIndicator([{value:"Si"},{value:"No"}]);
    setOpcionFuelLevel([{value:"Si"},{value:"No"}]);
    setOpcionWhistle([{value:"Si"},{value:"No"}]);
    setOpcionBatteryIndicator([{value:"Si"},{value:"No"}]);
    setOpcionEmergencyBrake([{value:"Si"},{value:"No"}]);
    setOpcionChairCushions([{value:"Si"},{value:"No"}]);
    setOpcionWiperWasher([{value:"Si"},{value:"No"}]);
    setOpcionInternalLights([{value:"Si"},{value:"No"}]);
    setOpcionInstrumentSpeedometerDashboard([{value:"Si"},{value:"No"}]);
    setOpcionEngineOil([{value:"Si"},{value:"No"}]);
    setOpcionHydraulicOilSteering([{value:"Si"},{value:"No"}]);
    setOpcionCoolantLiquid([{value:"Si"},{value:"No"}]);
    setOpcionBrakeFluid([{value:"Si"},{value:"No"}]);
    setOpcionFuelcap([{value:"Si"},{value:"No"}]);
    setOpcionBeltTension([{value:"Si"},{value:"No"}]);
    setOpcionMirrorGlass([{value:"Si"},{value:"No"}]);
    setOpcionHighLowBeams([{value:"Si"},{value:"No"}]);
    setOpcionTurnSignals([{value:"Si"},{value:"No"}]);
    setOpcionLogoPlates([{value:"Si"},{value:"No"}]);
    setOpcionTires([{value:"Si"},{value:"No"}]);
    setOpcionDeviceSpeed([{value:"Si"},{value:"No"}]);
    setOpcionSafetyBelts([{value:"Si"},{value:"No"}]);
    setOpcionFirstaidkit([{value:"Si"},{value:"No"}]);
    setOpcionLargeTent([{value:"Si"},{value:"No"}]);
    setOpcionExtinguisher([{value:"Si"},{value:"No"}]);
    setOpcionRoadTeam([{value:"Si"},{value:"No"}]);
    setOpcionSpareTire([{value:"Si"},{value:"No"}]);
  ...
  const edit = async () => {
    ...
    if(validates) { 
        let body = { 
          ...
          engineOilIndicator:opcionSelectEngineOilIndicator,
          fuelLevel:opcionSelectFuelLevel,
          whistle:opcionSelectWhistle,
          batteryIndicator:opcionSelectBatteryIndicator,
          emergencyBrake:opcionSelectEmergencyBrake,
          chairCushions:opcionSelectChairCushions,
          wiperWasher:opcionSelectWiperWasher,
          internalLights:opcionSelectInternalLights,
          instrumentSpeedometerDashboard:opcionSelectInstrumentSpeedometerDashboard,
          engineOil:opcionSelectEngineOil,
          hydraulicOilSteering:opcionSelectHydraulicOilSteering,
          coolantLiquid:opcionSelectCoolantLiquid,
          brakeFluid:opcionSelectBrakeFluid,
          fuelcap:opcionSelectFuelcap,
          beltTension:opcionSelectBeltTension,
          mirrorGlass:opcionSelectMirrorGlass,
          highLowBeams:opcionSelectHighLowBeams,
          turnSignals:opcionSelectTurnSignals,
          logoPlates:opcionSelectLogoPlates,
          tires:opcionSelectTires,
          deviceSpeed:opcionSelectDeviceSpeed,
          safetyBelts:opcionSelectSafetyBelts,
          firstaidkit:opcionSelectFirstaidkit,
          extinguisher:opcionSelectExtinguisher,
          roadTeam:opcionSelectRoadTeam,
          spareTire:opcionSelectSpareTire,
          largeTent:opcionSelectLargeTent 
        }
