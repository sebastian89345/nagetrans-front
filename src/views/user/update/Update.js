        ...
        <div className='user-update-card card'>
            <div className='card-body'>
              ...
              <div className=' text-center'>
                <p className='user-update-title'>Editar usuario</p>
              </div>
              <div className='mt-4'>
                <input value={inputName} onChange={(e) => setInputName(e.target.value)} type="text" className="user-update-input form-control" placeholder="Nombre del usuario" />
              </div>
              <div className='mt-4'>
